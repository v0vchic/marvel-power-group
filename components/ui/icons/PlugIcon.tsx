const PlugIcon = ({ className = '' }) => {
  return (
    ...
    >
      ...
      <path d="M15,24c-5.5,0-7-5.2-7.1-8c0-0.6,0.4-1,1-1c0,0,0,0,0,0c0.5,0,1,0.4,1,1
        c0,0.2,0.1,6,5.1,6c4.9,0,5-5.8,5-6V9c0-0.6,0.4-1,1-1s1,0.4,1,1v7
        C22,18.8,20.5,24,15,24z"
      />
    </svg>
  )
}
